...
static void print_exec(const struct syscallname *name, abi_long arg1,
...
static const struct syscallname venix_scnames[] = {
#include "strace.list"
};
 ...
 */
void print_venix_syscall(int num, abi_long arg1, abi_long arg2, abi_long arg3,
        abi_long arg4, abi_long arg5, abi_long arg6)
{

    print_syscall(num, venix_scnames, ARRAY_SIZE(venix_scnames), arg1, arg2,
            arg3, arg4, arg5, arg6);
}
...
void print_venix_syscall_ret(int num, abi_long ret)
{
    ...
    print_syscall_ret(num, ret, venix_scnames, ARRAY_SIZE(venix_scnames));
}
